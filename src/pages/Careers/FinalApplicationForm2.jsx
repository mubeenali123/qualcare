...
const handleNext = useCallback((e) => {
    ...
    window.scrollTo({ top: 0, behavior: "smooth" });
}, [currentStep, formData, iframePdfData, dispatch, getSignatureData, steps.length]);
...
}, [currentStep, formData, iframePdfData, dispatch, getSignatureData]);
            ...
            <div className="form-container">
                ...
                <form onSubmit={handleSubmit}>
                                    ...
                                    <div style={{ borderTop: '2px solid #000', paddingTop: '12px' }}>
                                        <div className="row" style={{ margin: '0' }}>
                                            ...
                                            <div className="form-field col-md-4" style={{ padding: '0 0 0 15px' }}>
                                                ...
                                                <CustomDatePicker name="w9SignDate" value={formData.w9SignDate} onChange={handleInputChange} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="form-section border p-3">
                                <div className="row mb-3">
                                    <div className="col-12">
                                        ...
                                        <div className="form-field mt-2 d-flex">
                                            ...
                                            <CustomDatePicker name="ahcaDecisionDate" value={formData.ahcaDecisionDate} onChange={handleInputChange} />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        ...
                                        <div className="form-field mt-2 d-flex">
                                            <i className="me-2 mb-2">Date of Decision:</i>
                                            <CustomDatePicker name="dohDecisionDate" value={formData.dohDecisionDate} onChange={handleInputChange} />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="form-section border p-3 mt-4">
                                ...
                                <div className="row mt-2">
                                    ...
                                    <div className="form-field col-md-6 d-flex">
                                        ...
                                        <CustomDatePicker name="priorScreeningDate" value={formData.priorScreeningDate} onChange={handleInputChange} />
                                    </div>
                                </div>
                    ...
                    <div className="form-actions">
                        ...
                        <button type="button" className="btn-save" onClick={handleSave} disabled={savingStep}>Save</button>
