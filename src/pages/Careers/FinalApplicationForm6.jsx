                            ...
                            <div className="form-section">
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-field col-md-6">
                                        ...
                                        <CustomDatePicker name="noticeDate" value={formData.noticeDate} onChange={handleInputChange} />
                                    </div>
                                </div>
                            </div>
                        </>
                        ...
                        <>
                            <div className="form-section">
                                ...
                                <div className="form-field">
                                    ...
                                    <CustomDatePicker name="dose1Date" value={formData.dose1Date} onChange={handleInputChange} />
                                </div>

                                <div className="form-field">
                                    <label className="section-label">Date Vaccinated – Dose 2</label>
                                    <CustomDatePicker name="dose2Date" value={formData.dose2Date} onChange={handleInputChange} />
                                </div>

                                <div className="form-field">
                                    <label className="section-label">Date Vaccinated – Dose 3</label>
                                    <CustomDatePicker name="dose3Date" value={formData.dose3Date} onChange={handleInputChange} />
                                </div>
                            ...
                            <div className="form-section">
                                ...
                                <div className="row mt-4 align-items-center">
                                    ...
                                    <div className="form-field col-md-6">
                                        <label className="section-label">Date</label>
                                        <CustomDatePicker name="declineDate" value={formData.declineDate} onChange={handleInputChange} />
                                    </div>
                                </div>
                            </div>
                        </>
