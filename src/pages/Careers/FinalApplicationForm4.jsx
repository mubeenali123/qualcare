...
const handleNext = useCallback((e) => {
    ...
    formDataToSend.append('step', stepName);
    ...
    window.scrollTo({ top: 0, behavior: "smooth" });
}, [currentStep, files, formData, dispatch, steps.length]);
...
}, [currentStep, files, formData, dispatch]);
                        ...
                        <>
                            ...
                            <div className="form-section">
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-field col-md-6">
                                        ...
                                        <CustomDatePicker name="date" value={formData.date} onChange={handleInputChange} required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="form-section">
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-field col-md-6">
                                        <label className="section-label">Date:</label>
                                        <CustomDatePicker name="registryDate" value={formData.registryDate} onChange={handleInputChange} required />
                                    </div>
                                </div>
                            </div>
                        </>
