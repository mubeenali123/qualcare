                            ...
                            <div className="form-section">
                                ...
                                <div className="row">
                                    <div className="form-field col-md-4">
                                        ...
                                        <CustomDatePicker name="authDate" value={formData.authDate || ''} onChange={handleInputChange} />
                                    </div>
                                    <div className="form-field col-md-4">
                            ...
                            <div className="form-section">
                                ...
                                <div className="row align-items-end mt-4">
                                    ...
                                    <div className="form-field col-md-3">
                                        <label className="section-label">DATE</label>
                                        <CustomDatePicker
                                            name="confidentialityStatementDate"
                        ...
                        <>
                            <div className="form-section">
                                ...
                                <div className="row align-items-end mt-4">
                                    ...
                                    <div className="form-field col-md-3">
                                        <label className="section-label">DATE</label>
                                        <CustomDatePicker name="healthDate" value={formData.healthDate} onChange={handleInputChange} />
                                    </div>
                                </div>
                            </div>
                        ...
                        <>
                            <div className="form-section">
                                ...
                                <div className="row align-items-end mt-4">
                                    ...
                                    <div className="form-field col-md-3">
                                        <label className="section-label">Date</label>
                                        <CustomDatePicker name="infectionControlDate" value={formData.infectionControlDate} onChange={handleInputChange} />
                                    </div>
                                </div>
                            </div>
                        ...
                        <>
                            <div className="form-section">
                                ...
                                <div className="row align-items-end mt-4">
                                    ...
                                    <div className="form-field col-md-3">
                                        <label className="section-label">Date</label>
                                        <CustomDatePicker name="policyDate" value={formData.policyDate} onChange={handleInputChange} />
                                    </div>
                                </div>
                            </div>
                        </>
