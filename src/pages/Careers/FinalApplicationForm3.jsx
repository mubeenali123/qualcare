...
const FinalApplicationForm3 = ({ formType = 'final_2' }) => {
    ...
    const handleNext = useCallback((e) => {
        ...
        window.scrollTo({ top: 0, behavior: "smooth" });
    }, [currentStep, formData, dispatch, steps.length]);
                        ...
                        <>
                            ...
                            <div className="form-section">
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-field col-md-6">
                                        ...
                                        <CustomDatePicker name="contractorDate" value={formData.contractorDate} onChange={handleInputChange} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="form-section">
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-field col-md-6">
                                        <label className="section-label">Date:</label>
                                        <CustomDatePicker name="registryDate" value={formData.registryDate} onChange={handleInputChange} />
                                    </div>
                                </div>
                            </div>
                        </>
                        ...
                        <>
                            <div className="form-section">
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-field col-md-6">
                                        <label className="section-label">Date</label>
                                        <CustomDatePicker name="witnessDate" value={formData.witnessDate} onChange={handleInputChange} />
                                    </div>
                                </div>
                            </div>
                            <div className="form-section">
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-field col-md-4">
                                        <label className="section-label">Date</label>
                                        <CustomDatePicker name="finalContractorDate" value={formData.finalContractorDate} onChange={handleInputChange} />
                                    </div>
                                </div>
                            </div>
                        </>
                        ...
                        <>
                            <div className="form-section">
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-field col-md-6">
                                        <label className="section-label">Date:</label>
                                        <CustomDatePicker name="date" value={formData.date} onChange={handleInputChange} />
                                    </div>
                                </div>
                            </div>
                        </>
